...
const gifts = [
  ...
  },
  {
    ...
    date: "08.04.2023",
    image:
      "https://cdn.discordapp.com/attachments/1008571088919343124/1089323633048031312/Philipp_Merk_2_cats_doing_a_bike_tour_in_the_mountains_a3cd58ae-75a6-42c4-ba12-e8e3fa2ef05a.png",
  },
  {
    id: 3,
    title: "Ein Tag im Spa",
    text: "Am dritten Tag beschlossen sie, einen Tag im Spa zu verbringen. Sie ließen sich von den sanften Wellen des Wassers in den Whirlpools und der Wärme verwöhnen. Sie genossen die Ruhe und Entspannung, die sie in diesem Moment erlebten. Als sie sich wieder auf den Weg machten, fühlten sie sich wie neu gebohrene Kadsen.",
    date: "09.04.2023",
    image:
      "https://cdn.discordapp.com/ephemeral-attachments/1008571088919343124/1089325876317003798/Philipp_Merk_2_cats_in_a_thermal_bath_718dde1d-74d8-448c-b0bb-630a7dbb7833.png",
  },
  {
    id: 4,
    title: "Tapas - 4 Gänge",
    ...
    date: "10.04.2023",
    image:
      "https://cdn.discordapp.com/attachments/1008571088919343124/1089324542138273832/Philipp_Merk_2_Cats_going_to_a_romantic_dinner_97b1c8e8-6400-46b2-9558-93c5cae63ccf.png",
  },
  {
    id: 5,
    title: "Bowling",
    text: "Schließlich, am letzten Tag ihres Abenteuers wollten sie sehen wie ehrenvollere der beiden Kadsen war. In einem Kopf-an-Kopf-Rennen, das bis zum letzten Moment andauerte, konnte Süßvieh sich schließlich durchsetzen und gewann das Spiel.",
    date: "11.04.2023",
    image:
      "https://cdn.discordapp.com/attachments/1008571088919343124/1089329104106569848/Philipp_Merk_cinema_romantic_2_cats_aadd8467-89fb-425e-850e-4fa019ea4519.png",
  },
];
      ...
      {gifts.map((gift) => (
        <SwiperSlide key={gift.id}>
          <div className="relative h-screen w-screen text-white">
            <section className="z-50 max-w-3xl w-full absolute left-3/4 top-3/4 -translate-x-1/2 -translate-y-1/2 text-justify bg-slate-800/80 p-5 rounded-3xl shadow-md">
